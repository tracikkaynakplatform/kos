...
export default function StepDigitalOceanSSHkey(props) {
	...
	return (
		<Wrapper onNextClick={() => {
			...
			<Typography>
				DigitalOcean hesabınızda işlem yapabilmek için <MUILink href='https://docs.digitalocean.com/glossary/ssh/'>SSH anahtarı parmak izi</MUILink> bilgisini girin.
			</Typography>
			<Box sx={{
				mt: '10px',
				mb: '10px',
				...
				<TextField onChange={(e) => setFingerprint(e.target.value)} value={fingerprint} label={translate('sshKeyFingerprint')} />
			</Box>
		</Wrapper>
	);
}
